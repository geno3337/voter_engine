        ...
        <>
            ...
            <aside id="sidebar" className="sidebar">
                ...
                <ul className="sidebar-nav" id="sidebar-nav">
                    ...
                    {/* <li className="nav-item">
                        <a className="nav-link " data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
                            <i className="bi bi-bar-chart"></i><span>Charts</span><i className="bi bi-chevron-down ms-auto"></i>
                        </a>
                        <ul id="charts-nav" className="nav-content collapse show" data-bs-parent="#sidebar-nav">
                            <li>
                            ...
                            <li>
                                <a href="charts-apexcharts.html" className="active">
